...
parSecurityInsightsOnboardingLock | No       | Resource Lock Configuration for Security Insights Onboarding.  - `kind` - The lock settings of the service which can be CanNotDelete, ReadOnly, or None. - `notes` - Notes about this lock.
